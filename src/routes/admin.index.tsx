...
export const Route = createFileRoute("/admin/")({
  head: () => seo({ title: "ניהול · סקירה", description: "נתוני מערכת: משתמשים, אירועים, קהילות, סטוריז ודיווחים פתוחים." }),
  component: Overview,
});
...
const CARDS: Array<{ key: keyof Overview; label: string; cls: string }> = [
  ...
  { key: "new_this_week", label: "חדשים השבוע", cls: "bg-success-soft text-success" },
  { key: "events", label: "אירועים", cls: "bg-event-soft text-event" },
  { key: "upcoming_events", label: "עתידיים", cls: "bg-violet-soft text-violet" },
  { key: "communities", label: "קהילות", cls: "bg-teal-soft text-teal" },
  { key: "active_stories", label: "סטוריז", cls: "bg-like-soft text-like" },
  { key: "open_reports", label: "דיווחים פתוחים", cls: "bg-partner-soft text-partner-strong" },
  { key: "banned", label: "מושהים", cls: "bg-destructive-soft text-destructive" },
];
